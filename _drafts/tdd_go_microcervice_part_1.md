...
Теперь паники в тестах больше нет.

Пока мы далеко не ушил и т.к. у нас есть тесты на весь работающий функционал, нужно провести небольшой рефакторинг, который касается наименования интерфейсов, чтобы не порождать зоопарк имен интерфейсов, приведем их все к виду `NameIface`.  Как видим это привело на данном этапе к минимальному кол-ву правок).
